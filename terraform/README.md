...
| <a name="input_firecrawl_api_resources"></a> [firecrawl\_api\_resources](#input\_firecrawl\_api\_resources) | Resource limits for Firecrawl API container | <pre>object({<br>    cpu    = string<br>    memory = string<br>  })</pre> | <pre>{<br>  "cpu": "0.5",<br>  "memory": "512Mi"<br>}</pre> | no |
...
| <a name="input_firecrawl_puppeteer_resources"></a> [firecrawl\_puppeteer\_resources](#input\_firecrawl\_puppeteer\_resources) | Resource limits for Firecrawl puppeteer container | <pre>object({<br>    cpu    = string<br>    memory = string<br>  })</pre> | <pre>{<br>  "cpu": "1",<br>  "memory": "1Gi"<br>}</pre> | no |
| <a name="input_firecrawl_redis_resources"></a> [firecrawl\_redis\_resources](#input\_firecrawl\_redis\_resources) | Resource limits for Firecrawl redis container | <pre>object({<br>    cpu    = string<br>    memory = string<br>  })</pre> | <pre>{<br>  "cpu": "0.25",<br>  "memory": "256Mi"<br>}</pre> | no |
...
| <a name="input_firecrawl_worker_resources"></a> [firecrawl\_worker\_resources](#input\_firecrawl\_worker\_resources) | Resource limits for Firecrawl worker container | <pre>object({<br>    cpu    = string<br>    memory = string<br>  })</pre> | <pre>{<br>  "cpu": "0.5",<br>  "memory": "512Mi"<br>}</pre> | no |
