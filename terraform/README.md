...
| <a name="input_firecrawl_redis_resources"></a> [firecrawl\_redis\_resources](#input\_firecrawl\_redis\_resources) | Resource limits for Firecrawl redis container | <pre>object({<br>    cpu    = string<br>    memory = string<br>  })</pre> | <pre>{<br>  "cpu": "0.25",<br>  "memory": "512Mi"<br>}</pre> | no |
